# Fix History & Reference Archive

Historical bug post-mortems, the license-system reference, and legacy behavioral notes — moved out of CLAUDE.md on 2026-06-03 to cut ~13K tokens/session of fixed context. NOT auto-loaded; read on demand when working in the relevant area. The live invariants distilled from these now live in CLAUDE.md.
