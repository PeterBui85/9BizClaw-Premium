...
#### Template gợi ý
Cấu trúc POL:
- **Cam kết lãnh đạo**: Tuyên bố từ CEO về ATVSLĐ
- **Quy tắc an toàn chung**: 10-15 quy tắc chính — dạng poster
- **PPE matrix**: Vị trí/Công việc × PPE bắt buộc × PPE khuyến nghị
- **Sơ cấp cứu**: Vị trí kit, người được đào tạo, quy trình
- **PCCC**: Vị trí bình chữa cháy, lối thoát hiểm, lịch diễn tập
- **Báo cáo tai nạn**: Form template + quy trình báo cáo 24h
- **Đào tạo ATVSLĐ**: Schedule hàng năm + nội dung bắt buộc
- **Xử lý vi phạm**: Mức độ vi phạm → Hình thức xử lý
