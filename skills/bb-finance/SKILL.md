...
- Đọc `skills/bb-finance/references/<tên-file>.md`
...
| Tạo tài liệu chiến lược | ❌ (ngoài phạm vi) |

## Quy Tắc Lưu Trữ

> Lưu tài liệu theo quy ước 9BizClaw: xuất file qua CEO File API / Google Drive (gog), đặt tên rõ ràng kèm năm/quý. Bảng gợi ý thư mục bên dưới là tùy chọn.
