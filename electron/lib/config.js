...
async function ensureDefaultConfig() {
  ...
  try {
    ...
    const REQUIRED_TOOLS = ['message', 'web_search', 'web_fetch', 'update_plan', 'read_file', 'list_files', 'search_files'];
    const BANNED_TOOLS = ['cron', 'process', 'read', 'write', 'apply_patch', 'memory', 'write_file', 'exec'];
