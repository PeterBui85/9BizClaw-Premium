...
const CHANNEL_DEFENSE = {
  whatsapp: {
    systemMsgDetector: (msg) => msg.messageStubType != null && msg.messageStubType !== 0,
    commandPatterns: SHARED_COMMAND_PATTERNS,
    dedupWindowMs: 3000,
    dedupMaxEntries: 500,
    botLoopEnabled: true,
    outputFilterLevel: 'full',
    allowlistFile: 'whatsapp-allowlist.json',
  },
  feishu: {
    systemMsgDetector: (msg) => msg.msgType === 'system' || msg.chatType === 'system_event',
    commandPatterns: [],
    dedupWindowMs: 3000,
    dedupMaxEntries: 200,
    botLoopEnabled: false,
    outputFilterLevel: 'light',
    allowlistFile: null,
  },
};
