...
const mustInclude = [
  ...
  ['9BizClaw update banner via _setUpdateLabelAvailable', 'function _setUpdateLabelAvailable(info)'],
  ['9BizClaw manual update preserved', 'async function _confirmAndStartUpdate()'],
